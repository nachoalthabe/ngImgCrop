 ...
 * License: MIT
 *
 * Generated at Monday, October 19th, 2015, 4:30:06 AM
 */
(function() {
'use strict';
...
crop.factory('cropHost', ['$document', 'cropAreaFace', 'cropAreaCircle', 'cropAreaSquare', 'cropEXIF', function($document, CropAreaFace, CropAreaCircle, CropAreaSquare, cropEXIF) {
  /* STATIC FUNCTIONS */
  ...
  return {
    ...
    link: function(scope, element/*, attrs*/) {
      ...
      events
        ...
        .on('area-rotate-end area-move-end area-resize-end image-updated area-reset', fnSafeApply(function(scope){
          updateResultImage(scope);
        }));
